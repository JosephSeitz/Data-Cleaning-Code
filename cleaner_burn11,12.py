...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 12 14:07:40 2019
...
Burn = int(input("What burn would you like to do? (11 or 12):"))
if Burn ==11:
    path = 'http://35.12.130.8/study/Seitz/10X10_Truss_SERDP_Burns/Raw-Sonic-TC-Data/SERDP-Burn-11/'
if Burn == 12:
    path = "http://35.12.130.8/study/2019-SERDP-RAW/August_download/SERDP%20Truss%20burn%2012/"
...
def compiler_b8():
    ...
    df_3884 = file_to_df(path, files[1])
    ...
    df_11584 = file_to_df(path, files[6])
    df_11585 = file_to_df(path, files[7])
    ...
    return all_sonics, all_tc_group

def correction():
    all_sonics, all_tc_group= compiler_b8()
