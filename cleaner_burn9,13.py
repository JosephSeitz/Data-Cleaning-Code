...
Burn = int(input("What burn would you like to do? (9 or 13):"))
if Burn == 9:
    path = 'http://35.12.130.8/study/2019-SERDP-RAW/August_download/SERDP%20Truss%20burn%209/'
if Burn == 13:
    path = "http://35.12.130.8/study/2019-SERDP-RAW/August_download/SERDP%20Truss%20burn%2013/"
def compiler_b8():
    ...
    file_num = ["2878","2879","3884","4390","4975","4976",\
                "10442",'11584',"11585"]
...
def correction():
    all_sonics, all_tc_group, df_WGNover = compiler_b8()
